...
import type { FulfillmentType } from "@ontime/web-shared";
...
// The storefront only supports one restaurant's cart at a time (see the
// TDD's open question on multi-restaurant carts) — adding an item from a
// different restaurant replaces whatever was there.
